...
nohup java -jar $DEPLOY_JAR --server.port=8080 --spring.config.location=classpath:/home/ubuntu/github_action/backend-config/application-front.yml >> $APPLICATION_LOG_PATH 2> $DEPLOY_ERR_LOG_PATH &
