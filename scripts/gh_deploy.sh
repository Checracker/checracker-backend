...
nohup java -jar $DEPLOY_JAR --server.port=8080 \ -Dspring.profiles.active=front --spring.config.location=classpath:/application-front.yml \ >> $APPLICATION_LOG_PATH 2> $DEPLOY_ERR_LOG_PATH &
