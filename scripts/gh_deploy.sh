...
nohup java -jar $DEPLOY_JAR --server.port=8080 --spring.profiles.active=front --spring.config.location=classpath:/application-front.yml,/home/ubuntu/github_action/front/src/main/resources/application-front.yml >> $APPLICATION_LOG_PATH 2> $DEPLOY_ERR_LOG_PATH &
